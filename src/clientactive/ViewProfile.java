...
//private String urlback="http://10.164.130.227:8080/Struts2_Hello_World/otherprofile";
private String urlback=MainActivity.urlpot+"Struts2_Hello_World/otherprofile";
private JSONArray resultarray;
private String nickname;
	public ViewProfile(String nickername){
		this.nickname=nickername;
	}
	/**
	 *
	 */
	...
	public void severtoprofile(){
	    ...
	    .build()); 
	     ...
	     try {
			...
			myuserId.put("nickname", this.nickname);
    ...
    public Profile getprofile(){
    	...
    	try {
    		System.out.println(this.resultarray);
